...
namespace quanjian.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(quanjianDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new quanjianAuthorizationProvider())
